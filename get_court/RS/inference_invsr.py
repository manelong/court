...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-i", "--in_path", type=str, default=r"/data/lijun/model/court/imgs/tmp", help="Input path")
    parser.add_argument("-o", "--out_path", type=str, default=r"/data/lijun/model/court/outputs", help="Output path")
    parser.add_argument("--bs", type=int, default=1, help="Batchsize for loading image")
    parser.add_argument("--chopping_bs", type=int, default=1, help="Batchsize for chopped patch")
    ...
    parser.add_argument(
        "--chopping_size", type=int, default=512, help="Chopping size when dealing large images"
    )
